...
if __name__ == '__main__':
    ...
    num_processes = 3  # Adjust based on your machine's capability
    ...
    save_path = os.path.join('result_varying_alpha', f'BS_results_N{sample_size}_3.pkl')
