...
for xi_size in xi_sizes:
    for group in range(num_groups):
        ...
        W =  np.array([
                        [[np.random.uniform(0.6,1.2), 0], 
                         [0, np.random.uniform(0.6,1.2)]]    
        ...
        # T = np.array([
        #                 [[np.random.uniform(3.5,4.5), np.random.uniform(8,10), np.random.uniform(6,8), np.random.uniform(9,11)],
        #                       [np.random.uniform(2.8,3.2),np.random.uniform(0.8,1.2),np.random.uniform(2.5,3.5),np.random.uniform(5,7)]]
        #     for i in range(xi_size) 
        #     ])
